...
DECLARE VARIABLE DependFieldCount Integer;
...
/*
SELECT *
FROM USPGETGRIDFIELD('20110613141426070000', 'uspGetRVList', NULL) p
*/

/******************************************************************************
**  File:        uspGetGridField.sql
**  Description: Returns User Customized Query List
**  Returns:     
**  Params:      @UserKey - The logged on users number
**               @GridDataSource
**				 @QueryType
*******************************************************************************
**  Change History
...
**	Tony.Cai	    2010/12/14	n/a  		Original.
**	Marco Cao    2011/08/13		YES		Sort function	
 ** Marco Cao	2017/01/05				show valve column in weld/ar/postioner page
 **	Robin Lu		    2016/01/16				N/A		for US184414--VKV Release:  VKViewer Generic/Todos Grid, available columns needs to include Valve data
 **	Robin Lu		    2016/01/19				N/A		for DE50321--VKV: Repair Sort is not correct if user from One Equipment type
**	Ben Song	2018/02/06		US288304    VKV:New columns: Previous event's Next Maint and Next Test Date
**                  02/26       ADD EQUIPTYPE FILTER WITH GRIDDEFAULTFIELD
...
BEGIN
	...
	-- handle depend field: PRENEXTMAINDATE,PRENEXTTESTDATE 
	DELETE FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'PRENEXTMAINDATE'; 
	INSERT INTO TEMPGRIDFIELD(  FIELDNAME,
								USERNAME,
								FIELDNUM,
								FIELDWIDTH,
								...
								CREATEDATE,
								DATATABLE)
	SELECT	'PRENEXTMAINDATE' AS FIELDNAME,
			TEMP.USERNAME  || ' - Previous Event',
			9999 AS FIELDNUM,
			200 AS FIELDWIDTH,
            (IIF((SELECT GRIDDISPLAYFIELD.SEQNO FROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PRENEXTMAINDATE')>0,(SELECT GRIDDISPLAYFIELD.SEQNO fROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PRENEXTMAINDATE'),0)) AS SEQNO,
            (SELECT COUNT(*) FROM GRIDDISPLAYFIELD WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PRENEXTMAINDATE') AS VISIBLE,
            '' AS FIELDTYPE,
            :CREATEDATE,
            'NA'
	FROM TEMPGRIDFIELD TEMP WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'NEXTMAINDATE' 
    AND EXISTS (SELECT 1 FROM GRIDDEFAULTFIELD WHERE GRIDDATASOURCE = :IN_GridDataSource AND FIELDNAME = 'PRENEXTMAINDATE'); 
  
	DELETE FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'PRENEXTTESTDATE'; 
	INSERT INTO TEMPGRIDFIELD(  FIELDNAME,
								USERNAME,
								FIELDNUM,
								FIELDWIDTH,
								...
								CREATEDATE,
								DATATABLE)
	SELECT	'PRENEXTTESTDATE' AS FIELDNAME,
			TEMP.USERNAME  || ' - Previous Event',
			9999 AS FIELDNUM,
			200 AS FIELDWIDTH,
            (IIF((SELECT GRIDDISPLAYFIELD.SEQNO FROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PRENEXTTESTDATE')>0,(SELECT GRIDDISPLAYFIELD.SEQNO fROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PRENEXTTESTDATE'),0)) AS SEQNO,
            (SELECT COUNT(*) FROM GRIDDISPLAYFIELD WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PRENEXTTESTDATE') AS VISIBLE,
            '' AS FIELDTYPE,
            :CREATEDATE,
            'NA'
	FROM TEMPGRIDFIELD TEMP WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'NEXTTESTDATE'    
	AND EXISTS (SELECT 1 FROM GRIDDEFAULTFIELD WHERE GRIDDATASOURCE = :IN_GridDataSource AND FIELDNAME = 'PRENEXTTESTDATE'); 

	-- handle depend field: MTHSGAPPREEVTNXTMAINTEST,MTHSGAPPREEVTNXTTESTTEST
	DELETE FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'MTHSGAPPREEVTNXTMAINTEST';
	...
	INSERT INTO TEMPGRIDFIELD(  FIELDNAME,
								...
								CREATEDATE,
								DATATABLE)
	SELECT	'MTHSGAPPREEVTNXTMAINTEST' AS FIELDNAME,
			'# Mths Gap ' || TEMP.USERNAME  || ' - Prev Next Maint',
			9999 AS FIELDNUM,
			200 AS FIELDWIDTH,
            (IIF((SELECT GRIDDISPLAYFIELD.SEQNO FROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'MTHSGAPPREEVTNXTMAINTEST')>0,(SELECT GRIDDISPLAYFIELD.SEQNO fROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'MTHSGAPPREEVTNXTMAINTEST'),0)) AS SEQNO,
            (SELECT COUNT(*) FROM GRIDDISPLAYFIELD WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'MTHSGAPPREEVTNXTMAINTEST') AS VISIBLE,
            '' AS FIELDTYPE,
            :CREATEDATE,
            'NA'
	FROM TEMPGRIDFIELD TEMP WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'DATETESTED'
	AND EXISTS (SELECT 1 FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'DATETESTED')
	AND EXISTS (SELECT 1 FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'PRENEXTMAINDATE')    
	AND EXISTS (SELECT 1 FROM GRIDDEFAULTFIELD WHERE GRIDDATASOURCE = :IN_GridDataSource AND FIELDNAME = 'MTHSGAPPREEVTNXTMAINTEST');  
    
    DELETE FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'MTHSGAPPREEVTNXTTESTTEST';
	...
	INSERT INTO TEMPGRIDFIELD(  FIELDNAME,
								...
								CREATEDATE,
								DATATABLE)
	SELECT	'MTHSGAPPREEVTNXTTESTTEST' AS FIELDNAME,
			'# Mths Gap ' || TEMP.USERNAME  || ' - Prev Next Test',
			9999 AS FIELDNUM,
			200 AS FIELDWIDTH,
            (IIF((SELECT GRIDDISPLAYFIELD.SEQNO fROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'MTHSGAPPREEVTNXTTESTTEST')>0,(SELECT GRIDDISPLAYFIELD.SEQNO fROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'MTHSGAPPREEVTNXTTESTTEST'),0)) AS SEQNO,
            (SELECT COUNT(*) FROM GRIDDISPLAYFIELD WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'MTHSGAPPREEVTNXTTESTTEST') AS VISIBLE,
            '' AS FIELDTYPE,
            :CREATEDATE,
            'NA'
	FROM TEMPGRIDFIELD TEMP WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'DATETESTED'
	AND EXISTS (SELECT 1 FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'DATETESTED')
	AND EXISTS (SELECT 1 FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'PRENEXTTESTDATE')   
	AND EXISTS (SELECT 1 FROM GRIDDEFAULTFIELD WHERE GRIDDATASOURCE = :IN_GridDataSource AND FIELDNAME = 'MTHSGAPPREEVTNXTTESTTEST');  
 
 	-- handle depend field: PREDATETESTED ,PREMAINTFOR  
	DELETE FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'PREDATETESTED';
	INSERT INTO TEMPGRIDFIELD(  FIELDNAME,
								USERNAME,
								FIELDNUM,
								FIELDWIDTH,
								...
								CREATEDATE,
								DATATABLE)
	SELECT	'PREDATETESTED' AS FIELDNAME,
			TEMP.USERNAME  || ' - Previous Event',
			9999 AS FIELDNUM,
			200 AS FIELDWIDTH,
            (IIF((SELECT GRIDDISPLAYFIELD.SEQNO FROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PREDATETESTED')>0,(SELECT GRIDDISPLAYFIELD.SEQNO fROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PREDATETESTED'),0)) AS SEQNO,
            (SELECT COUNT(*) FROM GRIDDISPLAYFIELD WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PREDATETESTED') AS VISIBLE,
            '' AS FIELDTYPE,
            :CREATEDATE,
            'NA'
	FROM TEMPGRIDFIELD TEMP WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'DATETESTED'
	AND EXISTS (SELECT 1 FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'DATETESTED')  
	AND EXISTS (SELECT 1 FROM GRIDDEFAULTFIELD WHERE GRIDDATASOURCE = :IN_GridDataSource AND FIELDNAME = 'PREDATETESTED');  
    
    DELETE FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'PREMAINTFOR';
	INSERT INTO TEMPGRIDFIELD(  FIELDNAME,
								USERNAME,
								FIELDNUM,
								FIELDWIDTH,
								...
								CREATEDATE,
								DATATABLE)
	SELECT	'PREMAINTFOR' AS FIELDNAME,
			TEMP.USERNAME  || ' - Previous Event',
			9999 AS FIELDNUM,
			200 AS FIELDWIDTH,
            (IIF((SELECT GRIDDISPLAYFIELD.SEQNO fROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PREMAINTFOR')>0,(SELECT GRIDDISPLAYFIELD.SEQNO fROM GRIDDISPLAYFIELD 
                    WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PREMAINTFOR'),0)) AS SEQNO,
            (SELECT COUNT(*) FROM GRIDDISPLAYFIELD WHERE USERKEY = :IN_UserKey AND GRIDDATASOURCE = :IN_GridDataSource AND 
               FIELDNAME = 'PREMAINTFOR') AS VISIBLE,
            '' AS FIELDTYPE,
            :CREATEDATE,
            'NA'
	FROM TEMPGRIDFIELD TEMP WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'MAINTFOR'
	AND EXISTS (SELECT 1 FROM TEMPGRIDFIELD WHERE CREATEDATE = :CREATEDATE AND FIELDNAME = 'MAINTFOR') 
	AND EXISTS (SELECT 1 FROM GRIDDEFAULTFIELD WHERE GRIDDATASOURCE = :IN_GridDataSource AND FIELDNAME = 'PREMAINTFOR');  
